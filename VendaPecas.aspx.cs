...
namespace SlnArCond
{
    public partial class VendaPecas : System.Web.UI.Page
    {
        ...
        public void ListarRpt()
        {
            mPecas P = new mPecas();
            List<pPecas> Lc = P.SelRepeater();
            rptProduto.DataSource = Lc;
            rptProduto.DataBind();
        ...
        protected void txtQuantidade_TextChanged(object sender, EventArgs e)
        {
            ...
            //}
            #region backup
            //decimal Q = Convert.ToDecimal(TxtQuantidade.Text);
            //decimal V = Convert.ToDecimal(lblValor.Text);
            //decimal Tot = Q * V;
